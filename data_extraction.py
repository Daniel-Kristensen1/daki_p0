...
def main():
    ...
    print("+-------------------------------+")
    image_path = r"C:\Users\Daniel K\OneDrive\Desktop\DAKI\1. Semester\daki_p0\KDD\55.jpg"
...
def get_terrain(tile,x ,y):
    ...
    hsv_data.append({"Coordinate": f"{x},{y}", "Hue": hue, "Saturation": saturation, "Value": value})
